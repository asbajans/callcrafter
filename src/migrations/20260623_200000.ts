...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  // Foreign keys
  await db.execute(sql`ALTER TABLE "tenant_credits" ADD CONSTRAINT IF NOT EXISTS "tenant_credits_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE set null ON UPDATE no action;`)
  await db.execute(sql`ALTER TABLE "credit_transactions" ADD CONSTRAINT IF NOT EXISTS "credit_transactions_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE set null ON UPDATE no action;`)
  await db.execute(sql`ALTER TABLE "credit_transactions" ADD CONSTRAINT IF NOT EXISTS "credit_transactions_credit_package_id_credit_packages_id_fk" FOREIGN KEY ("credit_package_id") REFERENCES "public"."credit_packages"("id") ON DELETE set null ON UPDATE no action;`)
  await db.execute(sql`ALTER TABLE "usage_logs" ADD CONSTRAINT IF NOT EXISTS "usage_logs_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE set null ON UPDATE no action;`)
  await db.execute(sql`ALTER TABLE "tenant_provider_access" ADD CONSTRAINT IF NOT EXISTS "tenant_provider_access_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE set null ON UPDATE no action;`)
  await db.execute(sql`ALTER TABLE "tenant_provider_access" ADD CONSTRAINT IF NOT EXISTS "tenant_provider_access_provider_id_ai_providers_id_fk" FOREIGN KEY ("provider_id") REFERENCES "public"."ai_providers"("id") ON DELETE set null ON UPDATE no action;`)
